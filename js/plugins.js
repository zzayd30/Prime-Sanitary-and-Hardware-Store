  ...
  return (function () {
    ...
    function n() {
      ...
      (this.addOnSelectEvent = function (t) {
        for (
          var e = t.querySelectorAll("td.selectable"), n = 0, a = e.length;
          n < a;
          n++
        )
        ...
        (this.onClickOutside = function (e) {
          ...
          do {
            if (
              a.matches(
                "#".concat(n.parentElement.id, ".datetime-container")
              ) ||
          ...
          i ||
            t.closePicker(n, n.previousElementSibling.querySelector(".active"));
        }),
        ...
        (this.roundMinutes = function (t) {
          ...
          t.forEach(function (t) {
            ...
            60 == n &&
              ((n = 0),
              24 == (a += 1) && ((a = 0), t.setDate(t.getDate() + 1))),
              t.setHours(a, n);
          });
        }),
        ...
        (this.setEndPickerProps = function (t, e) {
          ...
          if (null == n || "DIV" != n.nodeName)
            throw new Error(
              "Does div#".concat(t, " exist? Please, check your HTML code")
            );
            ...
            var a,
              ...
              c = function () {
                for (var t = "", n = 0; n <= 59; n++)
                  if (n % i.round_to == 0) {
                    if ((r.setHours(a, n), r < i.first_date || r > i.last_date))
                      continue;
                    var s = ("0" + n).slice(-2),
